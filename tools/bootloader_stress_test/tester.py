...
class BootloaderError(IntEnum):
    ...
    BOOTLOADER_INVALID_STATE                = 10001
    BOOTLOADER_APP_IMAGE_TOO_LARGE          = 10002
    BOOTLOADER_APP_STORAGE_WRITE_FAILURE    = 10003

    YMODEM_CHANNEL_WRITE_TIMED_OUT          = 20001
    YMODEM_RETRIES_EXHAUSTED                = 20002
    YMODEM_PROTOCOL_ERROR                   = 20003
    YMODEM_TRANSFER_CANCELLED_BY_REMOTE     = 20004
    YMODEM_REMOTE_REFUSED_TO_PROVIDE_FILE   = 20005

    UAVCAN_TIMEOUT                          = 30001
    UAVCAN_INTERRUPTED                      = 30002
    ...
    def request(self, payload, dest_node_id, timeout=None, priority=None):
        ...
        def callback(event):
            ...
            if event is not None:
                ...
                raise TimeoutError('Request to node %d with payload %r has timed out in %.3f seconds',
...
class Tester:
    ...
    def run(self):
        ...
        while True:
            bitrate = STANDARD_BIT_RATES[bitrate_index]
