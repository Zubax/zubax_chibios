...
CPPSRC += $(ZUBAX_CHIBIOS_DIR)/zubax_chibios/sys/sys_stm32.cpp                  \
          $(ZUBAX_CHIBIOS_DIR)/zubax_chibios/watchdog/watchdog_stm32.cpp        \
          $(ZUBAX_CHIBIOS_DIR)/zubax_chibios/config/config_storage_stm32.cpp    \
